...
from .gain_base import BaseEstimator, DataPreprocessorMixin
...
class GainImputation (BaseEstimator, DataPreprocessorMixin):
  ...
  """
  def __init__(self, file_name, mb_size=128, iterations=10000, p_hint=0.9, alpha=10, lr=0.001, random_state=None):
